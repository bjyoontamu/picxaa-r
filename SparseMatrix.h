...
class SparseMatrix {
 ...
 public:
  ...
  SparseMatrix (int seq1Length, int seq2Length, const VF &posterior, float cutoff) :
	...
	// SparseMatrix::SparseMatrix()
	//
	// Constructor.  Builds a sparse matrix from a posterior matrix in the
	// realmat format.
	/////////////////////////////////////////////////////////////////

	SparseMatrix(int seq1Length, int seq2Length, float **realmat) :
		seq1Length(seq1Length), seq2Length(seq2Length) {
